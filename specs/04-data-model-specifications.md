...
**Description**: Stores the pre-generated sitemap XML. A single document is maintained, periodically regenerated by a Cloud Scheduler job.
...
rate_limit_offenders (many documents)
    ...
    └── offender records managed at application level; real-time rate counting handled by Cloud Armor (see INFRA-005)
